...
Версия бота: **1.3** (в `user_agent` и в логах). Формат версии **X.Y**: первое число — мажор (миграции БД, изменения схемы или компонентов БД), второе — минор (исправления, устранение несоответствий).
